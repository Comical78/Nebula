...
from PyQt6.QtWidgets import QMainWindow, QWidget, QPushButton, QLabel, QLineEdit, QApplication, QMessageBox, QVBoxLayout
from PyQt6.QtGui import QPixmap, QIcon, QPalette, QBrush, QColor
...
class LoginWindow(QMainWindow):
    def __init__(self):
        ...
        self.setWindowFlags(Qt.WindowType.WindowCloseButtonHint | Qt.WindowType.MSWindowsFixedSizeDialogHint | Qt.WindowType.FramelessWindowHint)
        ...
        self.overlay_widget.setStyleSheet("background-color: rgba(0, 0, 0, 128);")  # 50% transparent black
    ...
    def register_account(self):
        ...
        try:
            ...
            if result.returncode != 0:
                QMessageBox.critical(self, "Error", "Cannot establish connection to database")
                return
